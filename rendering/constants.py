...
ATMOSPHERE_THICKNESS_PERCENT = 10.0
...
CLOUD_BASE_PERCENT = 55.0
CLOUD_LAYER_THICKNESS_PERCENT = 40.0
...
class PlanetParameters:
    ...
    moon_power: float = MOON_POWER
    moon_reflect_power: float = MOON_REFLECT_POWER
    ...
    def copy(self) -> "PlanetParameters":
        return PlanetParameters(
            ...
            moon_power=self.moon_power,
            moon_reflect_power=self.moon_reflect_power,
